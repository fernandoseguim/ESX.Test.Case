...
namespace ESX.Test.Case.Tests.Domain.Handlers
{
	...
	public partial class BrandHandlerTests : UnitTestBase
	{
		...
		private readonly ICommandHandler<BrandCommand> createBrandHandler;
		...
		public BrandHandlerTests()
		{
			...
			this.createBrandHandler = new BrandHandler(this.repository);
		}
		...
		{
			var commandResult = this.createBrandHandler.Create(this.brandCommand);
		...
		{
			var commandResult = this.createBrandHandler.Create(new BrandCommand());
		...
		{
			var commandResult = this.createBrandHandler.Create(new BrandCommand() { Name = MockString() });
